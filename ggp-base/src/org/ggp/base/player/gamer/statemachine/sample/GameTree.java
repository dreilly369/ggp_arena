...
public class GameTree<Key extends Comparable<Key>, Value> {
    ...
    private class Node {
        private Key key;           // key is States Hashcode
        private Value val;         // associated data is estimated utility for the state
        private Node left, right;  // links to left and right subtrees
        private boolean color;     // color of parent link
        private int N;             // subtree count
        private int visited;       // Number of visits to this node
    ...
    *************************************************************************/
    ...
    private int visitedNode(Node x) {
        if (x == null) return -1;
        x.visited++;
        return 0;
    }
    ...
    private int resetVisitedNode(Node x) {
        if (x == null) return -1;
        x.visited = 0;
        return 0;
    }
    ...
    private int getVisitCount(Node x) {
        if (x == null) return -1;
        return x.visited;
    }
    ...
    ***********************************************************************/
    ...
    public Iterable<Key> keys(Key lo, Key hi) {
        ...
        return (Iterable<Key>) queue.iterator();
    }
